                ...
                <article className="max-w-4xl mx-auto py-8 md:py-10 px-4 md:px-10 prose prose-indigo">
                    ...
                    <section className="mb-10">
                        ...
                        <p className="text-gray-600 leading-relaxed mb-3">
                            Navigate to the <code className="bg-gray-100 px-1.5 py-0.5 rounded text-sm text-indigo-700">cli/</code> directory and install dependencies:
                        </p>
...
npm install`}
                        ...
                        <ol className="list-decimal list-inside space-y-2 text-gray-600 mb-6">
                            <li>Run <code className="bg-gray-100 px-1.5 py-0.5 rounded text-sm text-indigo-700">node bin/ruil.js add</code> from the <code className="bg-gray-100 px-1.5 py-0.5 rounded text-sm text-indigo-700">cli/</code> directory.</li>
...
{`node bin/ruil.js add shadcn/button shadcn/card mui/TextField chakra/Modal`}
                        </pre>
                        <ol className="list-decimal list-inside space-y-2 text-gray-600 mb-6" start={2}>
                            ...
                            <li>shadcn components are <strong>batched</strong>: <code className="bg-gray-100 px-1.5 py-0.5 rounded text-sm text-indigo-700">npx shadcn-ui add button card</code></li>
                        ...
                        <div className="overflow-x-auto mb-6">
                            <table className="w-full text-sm border border-gray-200 rounded-xl overflow-hidden">
                                ...
                                <tbody className="text-gray-600">
                                    ...
                                    <tr className="border-b border-gray-100">
                                        <td className="px-4 py-2.5 font-bold">Ant Design</td>
...
{`$ node bin/ruil.js add shadcn/button shadcn/card mui/TextField --dry-run -y
  ...
  import { TextField } from "@mui/material";`}
                        ...
                        <h3 className="text-lg font-bold text-gray-700 mb-3 mt-6">Testing Locally</h3>
                        <p className="text-gray-600 leading-relaxed mb-4">
                            There are two ways to test the CLI on your machine:
                        </p>

                        <h4 className="text-base font-bold text-gray-700 mb-2">Option 1: Run Directly (Quickest)</h4>
                        <p className="text-gray-600 leading-relaxed mb-3">
                            From the <code className="bg-gray-100 px-1.5 py-0.5 rounded text-sm text-indigo-700">cli/</code> directory, use <code className="bg-gray-100 px-1.5 py-0.5 rounded text-sm text-indigo-700">node</code> to run any command:
                        </p>
...
# List all libraries
node bin/ruil.js list

# Search for a component across all libraries
node bin/ruil.js search modal

# Dry-run install (preview only, nothing is installed)
node bin/ruil.js add shadcn/button mui/Card --dry-run -y

# Interactive wizard mode
node bin/ruil.js add`}
                        </pre>

                        <h4 className="text-base font-bold text-gray-700 mb-2">Option 2: Link Globally with <code className="bg-gray-100 px-1.5 py-0.5 rounded text-sm text-indigo-700">npm link</code></h4>
                        <p className="text-gray-600 leading-relaxed mb-3">
                            This registers <code className="bg-gray-100 px-1.5 py-0.5 rounded text-sm text-indigo-700">ruil</code> as a system-wide command so you can use it from <strong>any React project</strong> on your machine:
                        </p>
                        <pre className="bg-gray-900 text-indigo-200 p-4 rounded-xl text-sm font-mono mb-3 overflow-x-auto leading-relaxed">
{`# Link the CLI globally (run once)
cd cli
npm link

# Now from ANY React project directory:
cd your-react-project/
ruil add                    # Interactive wizard
ruil add shadcn/button      # Direct install
ruil list shadcn            # Browse components`}
                        </pre>
                        <p className="text-sm text-gray-500 italic mb-6">
                            To unlink later: <code className="bg-gray-100 px-1.5 py-0.5 rounded text-sm text-indigo-700">npm unlink -g ruil</code>
                        </p>
                        ...
                        <div className="overflow-x-auto mb-4">
                            <table className="w-full text-sm border border-gray-200 rounded-xl overflow-hidden">
                                ...
                                <tbody className="text-gray-600">
                                    <tr className="border-b border-gray-100">
                                        <td className="px-4 py-2.5">Browse all libraries</td>
                                        <td className="px-4 py-2.5 font-mono text-xs text-indigo-700">node bin/ruil.js list</td>
                                    </tr>
                                    <tr className="border-b border-gray-100">
                                        <td className="px-4 py-2.5">Browse one library's components</td>
                                        <td className="px-4 py-2.5 font-mono text-xs text-indigo-700">node bin/ruil.js list shadcn</td>
                                    </tr>
                                    <tr className="border-b border-gray-100">
                                        <td className="px-4 py-2.5">Search across all libraries</td>
                                        <td className="px-4 py-2.5 font-mono text-xs text-indigo-700">node bin/ruil.js search button</td>
                                    </tr>
                                    <tr className="border-b border-gray-100">
                                        <td className="px-4 py-2.5">View library details</td>
                                        <td className="px-4 py-2.5 font-mono text-xs text-indigo-700">node bin/ruil.js info mui</td>
                                    </tr>
                                    <tr className="border-b border-gray-100">
                                        <td className="px-4 py-2.5">Preview install (safe)</td>
                                        <td className="px-4 py-2.5 font-mono text-xs text-indigo-700">node bin/ruil.js add shadcn/button --dry-run -y</td>
                                    </tr>
                                    <tr className="border-b border-gray-100">
                                        <td className="px-4 py-2.5">Interactive wizard</td>
                                        <td className="px-4 py-2.5 font-mono text-xs text-indigo-700">node bin/ruil.js add</td>
                                    </tr>
                                    <tr>
                                        <td className="px-4 py-2.5">Install for real</td>
                                        <td className="px-4 py-2.5 font-mono text-xs text-indigo-700">node bin/ruil.js add shadcn/button</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
