  ...
  return (
    <div className="bg-transparent space-y-8">
      ...
      <div className="space-y-6">
          ...
          <div className="grid grid-cols-2 gap-2">
            {[
              ...
              <button
                ...
                className={`text-left px-3 py-2.5 rounded-xl text-xs font-bold border transition-all duration-200 ${filters.category === cat.value
        ...
        <div>
          <label className={labelClassName}>
            <Package className="w-4 h-4 text-indigo-600" /> Framework
          </label>
