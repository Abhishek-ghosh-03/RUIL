...
const SplashScreen = ({ onFinish }) => {
  ...
  return (
    ...
    >
      ...
      {/* Anime Style Speed Lines / Particles */}
      <div className="absolute inset-0 pointer-events-none">
        {[...Array(20)].map((_, i) => (
          <motion.div
            ...
            className="absolute w-1 h-20 bg-indigo-500/10 rounded-full"
      ...
      <div className="absolute bottom-8 text-[9px] font-black text-gray-300 uppercase tracking-widest">
        Ver 2.1.0-STABLE / SYSTEM_ACTIVE
      </div>
    </motion.div>
  );
};
